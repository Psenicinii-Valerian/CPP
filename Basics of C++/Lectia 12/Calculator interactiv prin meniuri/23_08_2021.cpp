...
case 43 : if(B1) {cout<<'+'; op=0; val2 = val1;  B2=1; B1=0; val1=0;} else cout<<"ERROR :: DATI VALOAREA 1 !!!"<<endl; break; 
case 45 : if(B1) {cout<<'-'; op=1; val2 = val1;  B2=1; B1=0; val1=0;} else cout<<"ERROR :: DATI VALOAREA 1 !!!"<<endl; break;
case 42 : if(B1) {cout<<'*'; op=2; val2 = val1;  B2=1; B1=0; val1=0;} else cout<<"ERROR :: DATI VALOAREA 1 !!!"<<endl; break;
case 47 : if(B1) {cout<<'/'; op=3; val2 = val1;  B2=1; B1=0; val1=0;} else cout<<"ERROR :: DATI VALOAREA 1 !!!"<<endl; break;
case 94 : if(B1) {cout<<'^'; op=4; val2 = val1;  B2=1; B1=0; val1=0;} else cout<<"ERROR :: DATI VALOAREA 1 !!!"<<endl; break;
