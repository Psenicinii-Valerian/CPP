 	...
 	*/ 
 	...
 	class STRING
 	{
 		...
 		STRING( int value, char simbol ) 
	 	{
		 	cout<<" CONSTRUCTOR STRING V1 "<<endl; 
	 		cout<<" ";
 		...
 		STRING( char sir[], int value1, int value2  ) 
	 	{
		 	cout<<" CONSTRUCTOR STRING V2 "<<endl; 
	 		cout<<" ";
			
	 		for (int i=0; i<value2; i++)
	 		{
				this->sir[i] = sir[i+value1];
	 		}	
 	...
 	int main()
 	{
 		...
 		STRING v2("hello world STEP2022", 3, 10);
